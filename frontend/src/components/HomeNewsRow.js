...
const decreasedPink = alpha(pink[600], 0.775); // 0.7 is the alpha value, you can adjust it
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", height: "100%", marginTop: "2.5%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "row", marginTop: "1.35%", height: "1.5vh", alignItems: "center", width: "96%" }}>
          ...
          <Divider orientation="vertical" variant="middle" sx={{ height: "100%", marginRight: "2%", marginLeft: "2%" }} />
          <Typography variant="subtitle2" style={{ fontFamily: "Avenir", color: decreasedPink }}>Neg: {news.score[1][1]}</Typography>
          <Divider orientation="vertical" variant="middle" sx={{ height: "100%", marginRight: "2%", marginLeft: "2%" }} />
          <Typography variant="subtitle2" style={{ fontFamily: "Avenir", color: news.score[3][1] >= 0.05 ? teal[500] : news.score[3][1] <= -0.05 ? decreasedPink : 'grey' }}>Compound: {news.score[3][1]}</Typography>
        </div>
